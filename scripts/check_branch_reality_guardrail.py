...
SKIP_EXACT = {
    ...
    "data/validation/phase_16_forbidden_language_patterns.json",
    "data/validation/check_no_pregenerated_branch_tree_phase_16.spec.json",
    "data/validation/phase_17_forbidden_language_patterns.json",
