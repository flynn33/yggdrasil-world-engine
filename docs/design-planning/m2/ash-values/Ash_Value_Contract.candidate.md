...
**Replaces in the prepared review:** The open two-value-object construction and wire questions in sections 3–4 of `../readiness/M2_Packet_Contract.prepared.md`. It does not replace any approved product contract.  
